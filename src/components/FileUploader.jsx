...
const FileUploader = ({ filesProcessed, setFilesProcessed }) => {
    ...
    const handleReset = () => {
        ...
        document.getElementById('inputFilesInput').value = '';
    };
    ...
    return (
        <div className='main-div'>
            <input id="baseFileInput" type="file" accept=".csv" onChange={handleBaseFileChange} />
            <input id="inputFilesInput" type="file" accept=".csv" multiple onChange={handleInputFilesChange} />
